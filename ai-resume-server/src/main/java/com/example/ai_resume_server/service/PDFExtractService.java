        ...
        try (PDDocument document = PDDocument.load(file.getInputStream())) {
            ...
            String rules =
                    "You are an ATS resume analyzer. " +
                            ...
                            "ATS_SCORE: <score>; STRENGTHS: <comma separated strengths>; IMPROVEMENTS: <comma separated improvements>; JOB_MATCH: <percentage>; MISSING_KEYWORDS: <comma separated keywords>; SUMMARY: <one sentence final summary>. " +
                            "Strict rules: " +
                            "- Do NOT use JSON. " +
                            ...
                            "Example: ATS_SCORE: 70; STRENGTHS: good Java skills, strong projects; IMPROVEMENTS: add measurable achievements; JOB_MATCH: 65%; MISSING_KEYWORDS: spring boot, rest api; SUMMARY: candidate has solid fundamentals but needs more project depth. ";
